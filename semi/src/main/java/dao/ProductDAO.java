...
//
//	// 청소기 단일 정보 가져오기
//	public ArrayList<CleanerVO> getCleanerInfo(String pname) {
//		CleanerVO vo = null;
...
//
//		sb.setLength(0);
//		sb.append("SELECT pno, code, pname, pdesc, brand, price, to_char(regdate, 'yyyy-mm-dd') regdate, energy, imgfile, door, volume, codename, codename2 ");
...
//
//		sb.setLength(0);
//		sb.append("SELECT pno, code, pname, pdesc, brand, price, regdate, energy, imgfile, door, volume, codename, codename2 ");
